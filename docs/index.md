...
<span class="home-section-label">Start with what you need to do</span>
...
-   **Run large-scale analysis**
    ...
    [Go to HPC tasks](tasks/run-large-scale-analysis.md)
...
-   **Store and manage research data**
    ...
    [Go to storage tasks](tasks/store-and-share-research-data.md)

-   **Move data between systems**
    
    Use data transfer services to move data securely between your computer, UCT systems, HPC, and collaborators.

    [Go to data transfer services](services/data-transfer/index.md)

-   **Collaborate on code and research software**
    
    Use research software services to manage code, collaborate with others, and support reproducible software development.

    [Go to research software services](services/research-software/index.md)

</div>

---

<span class="home-section-label">Services at UCT eResearch</span>
...
-   **Research software**
    ...
    [Research software services](services/research-software/index.md)

</div>

---

<span class="home-section-label">How to use this documentation</span>
...
<div class="home-lower-band" markdown>

<div class="home-lower-band__about" markdown>
...
If you are unsure where to begin, start with [Choose the right service](start-here/choose-the-right-service.md).

</div>

<div class="home-lower-band__support" markdown>
...
[Go to support](support/index.md){ .md-button .md-button--primary }
